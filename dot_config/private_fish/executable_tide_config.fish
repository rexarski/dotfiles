#!/usr/bin/env fish
# tide_config.fish — Restore Tide universal variables on a fresh machine.
# Run once after Fisher installs Tide (install.fish does this automatically).
...
echo "  [done] Tide configuration applied."
